 ...
 */
final class Version20220203031611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE model (id VARCHAR(36) NOT NULL, product_id VARCHAR(36) NOT NULL, code VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_D79572D94584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE size (id VARCHAR(36) NOT NULL, model_id VARCHAR(36) NOT NULL, size VARCHAR(100) NOT NULL, value VARCHAR(100) NOT NULL, INDEX IDX_F7C0246A7975B7E7 (model_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
